...
?>
        <a href='StUpdateProfile.php'>Update Profile</a><br/><br/>
        <a href='RegisterQuestion.php'>Register Question</a><br/><br/>
        <a href='ShowQuestion.php'>My Questions</a><br/><br/>
        <a href='TestSkill.php'>Test Your Skills</a><br/><br/>
        <a href='Logout.php'>Logout</a><br/>
   <?php }
   $query="select * from exam_data where id=$id1";
